...
// The private mesh is guarded by its hostname suffix 'ts.net', not by the product name:
// naming the VPN is allowed and deliberate, publishing an address on it is not.
